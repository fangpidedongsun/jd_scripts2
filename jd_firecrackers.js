...
================Loon==============
[Script]
cron "10 8,21 * * *" script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_firecrackers.js,tag=她的节享京豆

===============Surge=================
她的节享京豆 = type=cron,cronexp="10 8,21 * * *",wake-system=1,timeout=3600,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_firecrackers.js

============小火箭=========
她的节享京豆 = type=cron,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_firecrackers.js, cronexpr="10 8,21 * * *", timeout=3600, enable=true
 */
