...
!(async () => {
  ...
  console.log(`\n开始帮作者助力，感谢！\n`);
  let shareCodes = [
    '992C19D88F59692E8406446B259889BA7576D92F605A797F5D3D565F5E8EEF2F49336DE54E26AA8F2834B248E6398CB7A755DF4FDAE585EC3E1ABE26F3DD3CFFC956D12974FF00A045D8E31A84FE84C18A8357DE96A1F617B8AC4D64BC24B689',
    '4839860754CD80CFA2D2DC97D28CE397462B7E1CB8A89B33E05AA74F568DFA5F74D05EDAD17077AFFA80DAD7387DD28B3BEE5701143FCA11A003164F79A3ADAEDDDA672BF446E2FCC0D1D6B4E52826D1'
  ];
  for (let i = 0; i < cookiesArr.length; i++) {
    cookie = cookiesArr[i];
    $.UserName = decodeURIComponent(cookie.match(/pt_pin=([^; ]+)(?=;?)/) && cookie.match(/pt_pin=([^; ]+)(?=;?)/)[1])
