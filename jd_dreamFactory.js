...
const inviteCodes = [
  '3XXm3AfmSd3gdxu0dMzAZQ==@_PqB6bOYJvvgeDYqwRhytA==',
];
...
async function joinLeaderTuan() {
  ...
  if (!res) res = await updateTuanIdsCDN('https://raw.fastgit.org/1994112/updateTeam1/master/shareCodes/jd_updateFactoryTuanId.json')
